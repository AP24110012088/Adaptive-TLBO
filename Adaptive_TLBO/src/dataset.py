...
class Dataset:
    ...
    def _build_indexes(self) -> None:
        ...
        self._days = self.timeslots["Day"].drop_duplicates().tolist()
        self._periods = sorted(self.timeslots["Period"].astype(int).unique().tolist())
    ...
    def get_days(self) -> List[str]:
        return self._days or self.DAYS

    def get_periods(self) -> List[int]:
        return self._periods or self.PERIODS
